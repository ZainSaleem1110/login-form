    ...
    return (
        <>
            <Box className="flex justify-center items-center mb-3 text-[#825AFF] relative">
                ...
                <Box className="absolute top-0 right-20">
                    <Box className="h-[25px] w-[5px] bg-[#825AFF] rounded-lg rotate-45"></Box>
                    <Box className="h-[14px] w-[5px] bg-white rounded-lg -rotate-45 mt-2"></Box>
                </Box>
            </Box>
                ...
                <Box className="sm:w-[600px] sm:px-0 px-10 py-10 bg-[#161719] flex justify-center items-center">
                    <Box className="sm:w-[350px] w-[250px]">
                        <Box>
                            ...
                            <input className="bg-black mt-1 pl-3 text-white h-[42px] w-[100%] rounded-sm text-[14px] focus:outline-none focus:ring focus:border-[#825AFF]" name="lastName" required placeholder="Enter your full name" />
                        </Box>
                        <Box className="mt-4">
                            <label className="text-white pl-3 block">Email</label>
                            <input className="bg-black mt-1 pl-3 text-white text-[14px] h-[42px] w-[100%] rounded-sm focus:outline-none focus:ring focus:border-[#825AFF]" type="email" name="Email" required placeholder="Enter your email address" />
                        </Box>
                        <Box className="mt-4">
                            <label className="text-white pl-3 block">Wallet Address</label>
                            <input className="bg-black mt-1 text-[14px] pl-3 text-white h-[42px] w-[100%] rounded-sm focus:outline-none focus:ring focus:border-[#825AFF]" type="email" name="Email" required placeholder="Enter your email address" />
                        </Box>
                        <Box className="mt-4">
                            <label className="text-white pl-3 block">Wallet Address</label>
                            <input className="bg-black mt-1 text-[14px] pl-3 text-white h-[42px] w-[100%] rounded-sm focus:outline-none focus:ring focus:border-[#825AFF]" type="email" name="Email" required placeholder="Enter your email address" />
